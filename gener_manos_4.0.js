...
// Crear una instancia de Mano y llamar a determinarDealer
let mano44 = new Mano();
mano44.determinarDealer();

function determinarDealer(numeroDealers){
    for(let i = 0; i < numeroDealers; i++){
        new Mano();
        determinarDealer(mano)
    }
}
